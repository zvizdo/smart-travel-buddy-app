...
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN="${NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN:-${PROJECT_ID}.firebaseapp.com}"
GA_MEASUREMENT_ID="${GA_MEASUREMENT_ID:-${NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID:-}}"
...
deploy_frontend() {
  ...
  gcloud builds submit "$REPO_ROOT" \
    ...
    --substitutions="_TAG=${tag},_NEXT_PUBLIC_FIREBASE_API_KEY=${NEXT_PUBLIC_FIREBASE_API_KEY},_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=${NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN},_NEXT_PUBLIC_FIREBASE_PROJECT_ID=${NEXT_PUBLIC_FIREBASE_PROJECT_ID},_NEXT_PUBLIC_FIREBASE_APP_ID=${NEXT_PUBLIC_FIREBASE_APP_ID:-},_NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID=${NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID:-},_NEXT_PUBLIC_GOOGLE_MAPS_API_KEY=${NEXT_PUBLIC_GOOGLE_MAPS_API_KEY},_NEXT_PUBLIC_BACKEND_URL=${backend_url},_NEXT_PUBLIC_MCP_SERVER_URL=${mcp_url}" \
    --quiet
...
deploy_mcpserver() {
  ...
  gcloud run deploy "$MCPSERVER_SERVICE" \
    ...
    --timeout=300 \
    --no-cpu-throttling \
    --set-env-vars="GOOGLE_CLOUD_PROJECT=${PROJECT_ID},GOOGLE_MAPS_API_KEY=${GOOGLE_MAPS_API_KEY_SERVER},API_KEY_HMAC_SECRET=${API_KEY_HMAC_SECRET},GA_MEASUREMENT_ID=${GA_MEASUREMENT_ID:-},GA_API_SECRET=${GA_API_SECRET:-}" \
    --quiet
